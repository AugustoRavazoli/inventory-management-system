    ...
    public void run(String... args) throws Exception {
        ...
        var orders = List.of(
                new Order(
                        ...
                        new Customer(1L),
                        List.of(
                                new OrderItem(1, new Product(1L)),
                                new OrderItem(2, new Product(2L)),
                                new OrderItem(3, new Product(3L))
                        )
                ),
                new Order(
                        Order.Status.UNPAID,
                        new Customer(2L),
                        List.of(
                                new OrderItem(4, new Product(1L)),
                                new OrderItem(5, new Product(2L)),
                                new OrderItem(6, new Product(3L))
                        )
                ), new Order(
                        Order.Status.UNPAID,
                        new Customer(3L),
                        List.of(
                                new OrderItem(7, new Product(1L)),
                                new OrderItem(8, new Product(2L)),
                                new OrderItem(9, new Product(3L))
                        )
                ), new Order(
                        Order.Status.UNPAID,
                        new Customer(4L),
